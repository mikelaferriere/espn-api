...
- Triggered release (patch) from the Actions UI.
...
- d0c12fa: Add more soccer leagues, including world cup
- d0c12fa: Add three international soccer leagues to the `League` enum and URL mapping:
...
- 7940ccc: Sync with new changes from official api
